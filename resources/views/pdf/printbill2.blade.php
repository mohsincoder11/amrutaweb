...
<body id="contentss">
	...
	<table class="ordertable" style="margin-top: 20px;">
		<tr style="height: 40px;text-align: left">
			...
			<th style="width:30px;text-align: left;height: 40px;">Alt Mob</th>
			<th style="width:20px;text-align: left;height: 40px;">MOP</th>
			<th style="width:10px;text-align: left;height: 40px;">Delivery charge</th>
		...
		<tr style="height: 40px; border-bottom: 1px solid black;text-align: left">
			...
			<td style="width:30px;padding-left:1px;"> {{$s['altmobile']}}</td>
			<td style="width:20px;padding-left:1px;"> {{$s['mop']}}</td>
			<td style="width:10px;padding-left:10px;"> {{$s['delivery_charge']}}</td>
