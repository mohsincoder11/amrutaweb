...
<body id="contentss">
    ...
    <p> <b>Amruta's Chicken</b> {{$shoporder->shopname}} .
        <br>
        {{$shoporder->address}}
        <br>
        Thanks for the order. Looking forward to serving you again.
    </p>
    <table class="headtable" style="margin-top: 20px;">
        ...
        <tr>
            <th style="width: 100px;text-align: left;">Branch Name:</th>
    ...
    <table class="ordertable" style="margin-top: 10px;font-size:15px;">
        ...
        <tr style="height: 40px; border-bottom: 1px solid black;text-align: left;">
            ...
            <td style="width:60px;">{{number_format($i->rate/$i->weight, 0, '.', '')}}</td>
    ...
    <tr style="border-bottom: 1px solid #cfcbc8;">
            <td style="width:120px;margin-left:-30px;line-height:2em">Total Amount: &nbsp;<span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                    {{$shoporder->amount+$shoporder->discount}}</td>
        </tr>
        <tr style="border-bottom: 1px solid #cfcbc8;">
            <td style="width:120px;margin-left:-30px;line-height:2em">Discount: &nbsp;<span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                    {{$shoporder->discount}}</td>
        </tr>
        <tr style="border-bottom: 1px solid #cfcbc8;">
            <td style="width:120px;margin-left:-30px;line-height:2em"><b>Gross Amount: &nbsp;<span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                    {{$shoporder->amount}}</b></td>
        </tr>
    </table>
</body>
