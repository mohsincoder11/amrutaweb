...
<html>
<head>
	<title>Telecaller Discount Report</title>
	<style type="text/css">
		body
		{
			font-size: 12px;
...
<body id="contentss">
	...
	<h3 style="text-align: center">Telecaller Discount Report</h3>
	...
	<table class="ordertable" style="margin-top: 20px;">
		...
		<tr style="height: 40px; border-bottom: 1px solid black;text-align: left" >
			...
			<td style="width:50px;padding-left:10px;height: 40px;">{{$t->created_at}}</td>
			<td style="width:80px;padding-left:10px;">
				{{$t->items}}
			</td>

			<td style="width:10px;padding-left:10px;"> {{$t->amount-$t->collectedcash}}</td>
		</tr>
