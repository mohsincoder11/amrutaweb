...
<head>
	<title>Cash Collection Shop Report</title>
	<style type="text/css">
		body {
			font-size: 12px;
		}
...
<body id="contentss">
	...
	<p><strong>Total Cash Collection : {{$totalcash}}</strong></p>
	...
	<table class="ordertable" style="margin-top: 20px;">
		<tr style="height: 40px;text-align: left">
			...
			<th style="width:60px;text-align: left;padding-left:10px;height: 40px;">Shop Name</th>
		...
		<tr style="height: 40px; border-bottom: 1px solid black;text-align: left">
			...
			<td style="width:50px;padding-left:10px;height: 40px;">
				@if($t->shopname==null)
				Admin
				@else
				{{$t->shopname}}
