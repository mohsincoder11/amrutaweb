	...
	<div class="row">
		<div class="col-md-12" style="margin-top:-15px;">
			...
			<div class="panel panel-default">
				...
				<h5 class="panel-title" style="color:#FFFFFF; background-color:#3c734a; width:100%; font-size:14px;" align="center"><i class="fa fa-phone"></i> &nbsp;Telecaller Order Report</h5>
				<div class="panel-body" style="margin-top:-10px; margin-bottom:-5px;">
					<div class="form-group"> 
						...
						<div class="row">
							...
							<div class="col-md-7">
								<form method="POST" action="{{url('telecallerorderreports')}}" class="form-horizontal" name="form" id="form" enctype="multipart/form-data">
									{{ csrf_field() }}                                       
									<div class="col-md-12">
							...
							<div class="col-md-3" >
								<form method="POST" action="{{url('printtelecallerorder')}}" class="form-horizontal" name="printform" id="printform" enctype="multipart/form-data" target="_blank">
									@csrf

									<div class="input-group col-md-12" style=" margin-bottom:15px;margin-top:2.4rem;">
										<input type="hidden" name="printfromdate" id="printfromdate" value="{{$fromdatepage ?? ''}}">
										<input type="hidden" name="teleorderweight" id="teleorderweight" value="{{number_format((float)$teleorderweight, 2, '.', '') ?? ''}}">
										<input type="hidden" name="printtodate" id="printtodate" value="{{$todatepage ?? ''}}">
										<input type="hidden" name="teleid" id="teleid" value="{{$telecallerid}}">
	...
	<div class="row">
		<div class="col-md-12" style="margin-top:-15px;">
			...
			<div class="panel panel-default">
				...
				<h5 class="panel-title" style="color:#FFFFFF; background-color:#3c734a; width:100%; font-size:14px;" align="center"><i class="fa fa-phone"></i> Telecaller Orders</h5>
				<div class="panel-body" style="margin-top:-10px; margin-bottom:-15px;">
					<div class="row" ><h3 style="margin-top: 10px;text-align: center">From :{{$fromdatepage ?? '' ?? ''}} &nbsp; To :{{$todatepage ?? '' ?? ''}} </h3>
						<h3 style="margin-top: 10px;text-align: center;color: black;">Telecaller :{{ucfirst($telecallername) ?? ''}} &nbsp; Total Order :{{$teleordercount}} &nbsp; Total Weight :{{number_format((float)$teleorderweight, 2, '.', '')}} KG </h3></div>
