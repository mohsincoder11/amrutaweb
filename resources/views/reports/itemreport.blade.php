	...
	<div class="row">
		<div class="col-md-12" style="margin-top:-15px;">
			...
			<div class="panel panel-default">
				...
				<h5 class="panel-title" style="color:#FFFFFF; background-color:#a43f3e; width:100%; font-size:14px;" align="center"><i class="fa fa-list"></i> &nbsp;Itemwise Report</h5>
				<div class="panel-body" style="margin-top:-10px; margin-bottom:-5px;">
					<div class="form-group"> 
						...
						<div class="row">
							...
							<div class="col-md-7">
								<form method="POST" action="{{url('itemreports')}}" class="form-horizontal" name="form" id="form" enctype="multipart/form-data">
									{{ csrf_field() }}                                       
									<div class="col-md-12">
										<div class="form-group" style="margin-top:-10px;">   
											...
											<div class="col-md-3" style="margin-top:15px; padding-left:5px; padding-right:2px;">
												...
												<div class="input-group">
													<select name="itemname" data-live-search="true" id="assignto" class="select">
											...
											<div class="col-md-3" style="margin-top:3.2rem; padding-left: 2%;" align="center">
							...
							<div class="col-md-3" >
								<form method="POST" action="{{url('printitemreport')}}" class="form-horizontal" name="printform" id="printform" enctype="multipart/form-data" target=_blank>
									@csrf
									...
									<div class="input-group col-md-12" style=" margin-bottom:15px;margin-top:2.4rem;">
										...
										{{$todatepage ?? '' ?? ''}}
										<?php endif ?>">
										<input type="hidden" name="itemname2" value="{{$itemname ?? ''}}">
										<input type="hidden" name="itemcount2" id="itemcount2" value="{{$itemcount ?? ''}}">
	...
	<div class="row">
		<div class="col-md-12" style="margin-top:-15px;">
			...
			<div class="panel panel-default">
				...
				<h5 class="panel-title" style="color:#FFFFFF; background-color:#a43f3e; width:100%; font-size:14px;" align="center"><i class="fa fa-list"></i> Items List </h5>
				<div class="panel-body" style="margin-top:-10px; margin-bottom:-15px;">
					<div class="row" ><h3 style="margin-top: 10px;text-align: center">From :{{$fromdatepage ?? ''}} &nbsp; To :{{$todatepage ?? ''}} </h3><h3 style="margin-top: 10px;text-align: center;color: black;">Item :{{ucfirst($itemname ?? '')}} &nbsp; Total Order :{{$itemcount ?? ''}} &nbsp; Total Kg :{{number_format((float)$totalkg, 2, '.', '')}}&nbsp; Total Amount :{{$totalrate ?? ''}} </h3></div>
					...
					<table class="table" id="shoporder">
						...
						<tbody>
							<?php 
							if($shopitem!=null || $teleitem!=null) 
							{
								?>

								@foreach($shopitem as $a)
								<tr>
									<td>
										{{$a->id}}
...
<script>
	...
	$(document).ready( function () {
		...
		var shopordercount=$('#itemcount2').val();
