        ...
        <div class="row">
            <div class="col-md-12" style="margin-top:-15px;">
                ...
                <div class="panel panel-default">
                    ...
                    <h5 class="panel-title" style="color:#FFFFFF; background-color:#2fa890; width:100%; font-size:14px;"
                        align="center"><i class="fa fa-home"></i> &nbsp;Daily Entry for Shop</h5>
                    ...
                    <div class="panel-body" style="margin-top:-10px; margin-bottom:-5px;">
                        <div class="form-group">
                            ...
                            <form role="form" id="dailyentryform" method="post" action="{{ url('insertdailyentry') }}">
                                @csrf
                                    ...
                                    <div class="form-group" style="margin-top:-10px;">
                                        <div class="col-md-2" style="margin-top:15px;">
                                            ...
                                            <select name="" id="shopmodel_select" class="form-control select">
                                                ...
                                                @foreach ($shops as $g)
                                                    <option value="{{ $g->id }}"
                                                        birds_weights="{{ $g->birds_weights }}"
                                                        shop_user_id="{{ $g->userid }}"
                                                        opening_birds="{{ $g->opening_birds }}">{{ $g->shopname }}
                                        ...
                                        <div class="col-md-2" style="margin-top:15px;">
                                            ...
                                            <input type="text" name="opening_amount" id="opening_amount"
                                                placeholder="Opening Amount" class="form-control closing_amount_cal"
                                                readonly="" value="0" required />
                                        </div>
                                        <div class="col-md-2" style="margin-top:15px;">
                                            <label>Opening Birds<font color="#FF0000"></font></label>
                                            <input type="text" name="openingbirds" id="openingbirds"
                                                placeholder="Opening Birds" class="form-control" readonly="" required />
                                        </div>
                                        <div class="col-md-2" style="margin-top:15px;">
                                            <label>Avg Body Wt<font color="#FF0000"></font></label>
                                            <input type="number" name="avg_body_wt" id="avg_body_wt"
                                                placeholder="Average Body Weight" class="form-control callculate_closing"
                                                readonly="" required />
                                        </div>
                                        <div class="col-md-2" style="margin-top:15px;">
                                            <label>Sale Birds<font color="#FF0000"></font></label>
                                            <input type="number" name="salegbird" id="salegbird"
                                                placeholder="Sale Birds" class="form-control callculate_closing"
                                                required />
                                        </div>

                                        <div class="col-md-2" style="margin-top:15px;">
                                            <label>Bill Qty. Wt.<font color="#FF0000"></font></label>
                                            <input type="number" value="0" readonly step="0.01"
                                                name="billqtywt" id="billqtywt" placeholder="Bill Qty"
                                                class="form-control" required />
                                        </div>
                                        <div class="col-md-2" style="margin-top:15px;">
                                            <label>Stock Chicken Sale<font color="#FF0000"></font></label>
                                            <input type="number" value="0" step="0.1" name="stock_chick_sale"
                                                id="stock_chick_sale" placeholder="Stock Chicken Sale"
                                                class="form-control calculate_sale_wt" required />
                                        </div>
                                        <div class="col-md-2" style="margin-top:15px;">
                                            <label>Stock Gurda-Kaleji Sale<font color="#FF0000"></font></label>
                                            <input type="number" value="0" step="0.1" name="stock_g_k_sale"
                                                id="stock_g_k_sale" placeholder="Stock Gurda-Kaleji Sale"
                                                class="form-control calculate_sale_wt" required />
                                        </div>
                                        <div class="col-md-2" style="margin-top:15px;">
                                            <label>Sale Wt.(Meat)<font color="#FF0000"></font></label>
                                            <input type="number" readonly="readonly" step="0.01" name="salegwt"
                                                id="salegwt" placeholder="Sale Weight" class="form-control" required />
                                        </div>
                                        <div class="col-md-2" style="margin-top:15px;">
                                            <label>Today Total Meat<font color="#FF0000"></font></label>
                                            <input type="number" readonly="readonly" step="0.01"
                                                name="today_total_meat" id="today_total_meat"
                                                placeholder="Today total meat" class="form-control" required />
                                        </div>

                                        <div class="col-md-2" style="margin-top:15px;">
                                            <label>Mortality<font color="#FF0000"></font></label>
                                            <input type="number" name="mortality" id="mortality" value="0"
                                                placeholder="Mortality" class="form-control callculate_closing"
                                                required />
                                        </div>
                                        ...
                                        <div class="col-md-2" style="margin-top:15px;">
                                            ...
                                            <input type="number" step="0.01" name="wt" id="wt"
                                                placeholder="Weight" class="form-control" required />
                                        </div>
                                        <div class="col-md-2" style="margin-top:15px;">
                                            <label>Closing Birds<font color="#FF0000"></font></label>
                                            <input type="number" name="closingbird" id="closingbird"
                                                placeholder="Closing Birds" class="form-control" readonly=""
                                                required />
                                        </div>
                                        <div class="col-md-2" style="margin-top:15px;">
                                            <label>Total Sale Amt.<font color="#FF0000"></font></label>
                                            <input type="number" name="tsaleamt" id="tsaleamt"
                                                placeholder="Total Sale Amount" class="form-control closing_amount_cal"
                                                value="0" required />
                                        </div>
                                        <div class="col-md-2" style="margin-top:15px;">
                                            <label>Dis. Amount<font color="#FF0000"></font></label>
                                            <input type="number" name="disamt" id="disamt" value="0"
                                                placeholder="Discount Amount" class="form-control" required />
                                        </div>
                                        <div class="col-md-2" style="margin-top:15px;">
                                            <label>Deposit Amount Bank<font color="#FF0000"></font></label>
                                            <input type="number" name="deposit_amount_bank" id="deposit_amount_bank"
                                                value="0" placeholder="Dscount Amount Bank"
                                                class="form-control closing_amount_cal" required />
                                        </div>
                                        <div class="col-md-2" style="margin-top:15px;">
                                            <label>Deposit Amount Office<font color="#FF0000"></font></label>
                                            <input type="number" name="deposit_amount_office" id="deposit_amount_office"
                                                value="0" placeholder="Dscount Amount Office"
                                                class="form-control closing_amount_cal" required />
                                        </div>
                                        <div class="col-md-2" style="margin-top:15px;">
                                            <label>Deposit Amount PhonePay<font color="#FF0000"></font></label>
                                            <input type="number" name="deposit_amount_phonepay"
                                                id="deposit_amount_phonepay" value="0"
                                                placeholder="Dscount Amount phonepay"
                                                class="form-control closing_amount_cal" required />
                                        </div>
                                        <div class="col-md-2" style="margin-top:15px;">
                                            <label>Expenses<font color="#FF0000"></font></label>
                                            <input type="number" name="expenses" id="expenses" value="0"
                                                placeholder="Daily Expense" class="form-control closing_amount_cal"
                                                required />
                                        </div>
                                        <div class="col-md-2" style="margin-top:15px;">
                                            <label>Closing Amount<font color="#FF0000"></font></label>
                                            <input type="number" name="closing_amount" id="closing_amount"
                                                value="0" placeholder="Closing Amount " class="form-control"
                                                required />
                                        </div>

                                        <div class="col-md-2" style="margin-top:15px;">
                                            <label>Meat Percentage<font color="#FF0000"></font></label>
                                            <input type="number" step="0.01" name="meat_percent" id="meat_percent"
                                                value="0" placeholder="Meat Percentage" class="form-control"
                                                readonly="" required />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12" style="margin-top:15px;">
                                            <button type="submit" class="btn btn-info "><span class="fa fa-plus">
                                                </span> Add</button>
                                        </div>
                            ...
                            <div class="panel-body" style="margin-top:-10px; margin-bottom:-15px;">
                                <table border="0" cellspacing="5" cellpadding="5">
                                    <tbody>
                                        <tr>
                                            <td>Start date:</td>
                                            <td><input class="form-control pt-4" type="text" id="min"
                                                    name="min"></td>
                                        </tr>
                                        <tr>
                                            <td>End date:</td>
                                            <td><input class="form-control" type="text" id="max"
                                                    name="max"></td>
                                        </tr>
                                    </tbody>
                                </table>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(a, b) {
                            ...
                            $("#dailyentryrow").append(
                                '<tr><td>' + b.id + '</td><td>' + b.date + '</td><td>' +
                                shopname + '</td><td>' + b.time + '</td><td>' + b
                                .openingbirds + '</td><td>' + b.salegbird + '</td><td>' +
                                salegwt + '</td><td>100</td><td>' + b.mortality +
                                '</td><td>' + wt + '</td><td>' + b.expenses + '</td><<td>' +
                                b.closingbird + '</td><td>' + b.tsaleamt + '</td><td>' + b
                                .disamt + '</td><td>' + b.meat_percent + '</td><td>' + b
                                .closing_amount +
                                '</td><td><a  class="modal-effect btn btn-danger btn-xs rounded-circle delete" data-toggle="modal" data-effect="effect-sign" id=' +
                                b.id +
                                ' data-toggle="tooltip-danger" title="Delete Record" data-placement="top"><i class="fa fa-trash"></i></a></td></tr>'
                            );
            ...
            $("#loader").hide();
            $("#dailyentryform").submit(function(e){
                $("#dailyentryform button[type='submit']").addClass("disabled");
            ...
            $(".closing_amount_cal").on('keyup', function() {
                var closing_amount = (parseFloat($("#opening_amount").val()) + parseFloat($("#tsaleamt")
                        .val())) -
                    (parseFloat($("#deposit_amount_bank").val()) + parseFloat($("#deposit_amount_office")
                        .val()) + parseFloat($("#expenses").val()) + parseFloat($(
                        "#deposit_amount_phonepay").val()));
            ...
            $(".calculate_sale_wt").on('keyup', function() {
                ...
                var salegwt = parseFloat(billqtywt) - parseFloat(stock_chick_sale) - parseFloat(
                    stock_g_k_sale);
                $("#salegwt").val(salegwt.toFixed(4));

                let today_total_meat = parseFloat(salegwt) + parseFloat(today_sale_Chicken) + parseFloat(
                    today_sale_gurda_kaleji);
