        ...
        <div class="panel-body">
          <div class="form-group">
            <div class="col-md-12" align="center" style="margin-top:-12px;">
              <h5 style="color:#000; background-color:#FFCC00; width:15%; min-height:25px; padding-top:5px;" align="center"><span class="fa fa-user"></span> <strong>Live Bird Transfer Dashboard</strong></h5>
            </div>


                       @include('live_bird_transfer/live_bird_layout')
...
<div class="row">
    <div class="col-md-12" style="margin-top:-15px;">
       ...
       <div class="panel panel-default">
        ...
        <h5 class="panel-title" style="color:#FFFFFF; background-color:#CC0033; width:100%; font-size:14px;" align="center"><i class="fa fa-home"></i> &nbsp;Godawn to Godawn Transfer</h5>
 ...
 <form role="form" method="post" action="{{url('insertgtog')}}">
                ...
                <input type="hidden" name="updateid" id="updateid">
                        ...
                        <div class="col-md-2" style="margin-top:15px;">
                            ...
                            <input type="text" name="avgwt" id="avgwt" placeholder="Average Bird Weight" class="form-control" required/>
                        </div>
