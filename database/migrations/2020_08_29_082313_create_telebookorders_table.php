...
class CreateTelebookordersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('telebookorders', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('telebookorders');
    }
}
